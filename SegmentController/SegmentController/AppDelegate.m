...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  ...
  UIViewController * there = [[UIViewController alloc] init];
  OneViewController * four = [[OneViewController alloc] init];
  UIViewController * five = [[UIViewController alloc] init];
  NSArray * viewControllerArray = @[one,two,there,four,five];
  NSArray * segmentItems = @[@"首页",@"推荐",@"热门",@"优惠",@"便宜"];
  
  XDSegmentViewController * vc1 = [[XDSegmentViewController alloc] init];
  vc1.segmentItems = segmentItems;
  vc1.viewControllerArray = viewControllerArray;
